...
def send_email(recipient, parma_id, parma_name, contacts, plant_details, supplier_unb,mail_sub,mail_body,template_path, plantList):
    try:
        # Set the correct path for the email template
        # template_path = r"C:\Rohit P\PLE Cloning\edi-impl-app\mail templates\UD EDI DELFOR and DESADV in production.html"
        ...
        mail.Subject = f"{parma_id} - {plantList} -- {mail_sub}"
